    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container" style="margin-top: 15px;">
            ...
            <div class="row justify-content-center">
               ...
               ?>
                <form name="loginForm" action="?command=login" method="post" >
                    ...
                    <button type="submit" class="btn btn-primary" id="loginSubmit">Enter</button>
                    </div>
                </form>
        ...
        <script>
            ...
            let user = {useremail:email, username:name, userpwd:password};
            if (user.useremail == "" || user.username =="" || user.userpwd =="") {
